...
useEffect(() => {
  ...
  return (
          ...
          <Grid item>
            <MDBox height="100%" mt={0.5} lineHeight={1}>
              ...
              <MDTypography variant="button" color="text" fontWeight="regular">
                ...
                truckData.driver
                :
                <b><CardActions>driver not assigned<Button onClick={()=>navigate('/assigndriver',{state:{truckId:truckData.plateNo}})} size="small">assign driver</Button></CardActions></b>
                }
              </MDTypography>
            </MDBox>
          </Grid>
    ...
    <Box sx={{ minWidth: 275,display:'flex',justifyContent:'space-around',flexWrap:'wrap' }}>
      <Card variant="outlined" sx={{ minWidth: 345,backgroundColor:'#222222',marginTop:'40px' }}>
            <React.Fragment>
                    <CardContent>
      ...
      <Card variant="outlined" sx={{ minWidth: 345,backgroundColor:'#222222',marginTop:'40px' }}>
            <React.Fragment>
                    ...
                    <Typography variant="h5" component="div" sx={{color:'#00FFDD'}}>
                        SET
                    </Typography>
                    <Typography variant="h1" component="div" sx={{color:'#00FF77', fontSize: 50,display:'block' }}>
                        {task?.weight? task.weight: 10}<span style={{fontSize: 25,color:'#00FF77'}}>ton</span>
                    </Typography>
                    <Typography variant="h5" component="div" >
                        CURRENT
                    </Typography>
                    <Typography variant="h1" component="div" sx={{ fontSize: 100,display:'block' }}>
                        {fuel}<span style={{fontSize: 50,color:'#4169e1'}}>ton</span>
                    </Typography>
                    </CardContent>
                    <CardActions>
                        {/* <Button size="small">take action</Button> */}
      ...
      <Card variant="outlined" sx={{ minWidth: 400,backgroundColor:'#222222',marginTop:'40px' }}>
          <React.Fragment>
            <CardContent>
            ...
            <CardActions>
              <Button size="small"><a href={maplink} target='_blank'>view on map</a></Button>
            </CardActions>
          </React.Fragment>
      </Card>
    </Box>
